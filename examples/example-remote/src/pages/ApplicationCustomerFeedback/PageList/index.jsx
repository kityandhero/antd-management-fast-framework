...
class PageList extends MultiPage {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      pageTitle: '顾客反馈列表',
      paramsKey:
        accessWayCollection.applicationCustomerFeedback.pageList.paramsKey,
      loadApiPath:
        modelTypeCollection.applicationCustomerFeedbackTypeCollection.pageList,
      currentRecord: null,
    };
  }
  ...
  goToEdit = (record) => {
    const applicationCustomerFeedbackId = getValueByKey({
      data: record,
    ...
    this.goToPath(
      `/applicationFeedback/applicationCustomerFeedback/edit/load/${applicationCustomerFeedbackId}/key/basicInfo`,
    );
  };
  ...
  getColumnWrapper = () => [
    ...
    {
      dataTarget: fieldData.applicationCustomerFeedbackId,
      width: 120,
      showRichFacade: true,
      canCopy: true,
    },
