...
const visibleFlag = 'c76f223f6c8b4c23a7630e86f837d799';
...
class ChangeSortModal extends BaseUpdateModal {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      submitApiPath: 'businessSet/updateSort',
    };
  }
  ...
  supplementLoadRequestParams = (o) => {
    ...
    const { businessSetId } = externalData;

    d[fieldData.businessSetId.name] = businessSetId;
