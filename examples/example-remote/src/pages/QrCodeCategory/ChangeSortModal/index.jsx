...
const visibleFlag = '7e391f16135049a6b0f8a533650e631d';
...
class ChangeSortModal extends BaseUpdateModal {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      submitApiPath: 'qrCodeCategory/updateSort',
    };
  }
  ...
  supplementLoadRequestParams = (o) => {
    ...
    const { qrCodeCategoryId } = externalData;

    d[fieldData.qrCodeCategoryId.name] = qrCodeCategoryId;
