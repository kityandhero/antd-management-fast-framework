...
class Edit extends DataTabContainerSupplement {
      ...
      buttons: [
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.administrativeDivision.setOnline.permission,
          ),
        ...
        },
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.administrativeDivision.setOffline.permission,
          ),
  ...
  establishPageHeaderContentGridConfig = () => {
    ...
    return [
      {
        label: fieldData.administrativeDivisionId.label,
        value: getValueByKey({
          data: metaData,
