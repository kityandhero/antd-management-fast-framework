...
const visibleFlag = 'f8b1f8a019754a84a26cc150b84d43ac';
...
class AddBasicInfoDrawer extends BaseAddDrawer {
  ...
  componentAuthority = accessWayCollection.position.addBasicInfo.permission;
  ...
  constructor(properties) {
    ...
    this.state = {
      ...this.state,
      pageTitle: '新增信息',
      submitApiPath: 'position/addBasicInfo',
    };
  }
