...
const visibleFlag = '588002488e1249859e75ce45a7fe1127';

@connect(({ workflowBranchCondition, schedulingControl }) => ({
  workflowBranchCondition,
  schedulingControl,
}))
class AddFormFieldBasicInfoModel extends BaseAddModal {
  static open() {
  ...
  onTargetNameChange = (v) => {
    const data = {};

    data[fieldData.targetName.name] = v;
...
export { AddFormFieldBasicInfoModel };
