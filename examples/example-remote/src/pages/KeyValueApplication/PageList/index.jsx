...
@connect(({ keyValueApplication, schedulingControl }) => ({
  keyValueApplication,
  schedulingControl,
}))
class PageList extends MultiPage {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...this.state,
      pageTitle: '应用键值列表',
      paramsKey: accessWayCollection.keyValueApplication.pageList.paramsKey,
      loadApiPath: 'keyValueApplication/pageList',
      tableScrollX: 1760,
  ...
  establishListItemDropdownConfig = (item) => {
    return {
      ...
      disabled: !checkHasAuthority(
        accessWayCollection.keyValueApplication.get.permission,
      ),
      ...
      items: [
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.keyValueApplication.refreshCache.permission,
          ),
          confirm: true,
          title: '即将刷新缓存，确定吗？',
        },
  ...
  getColumnWrapper = () => [
    ...
    {
      dataTarget: fieldData.keyValueApplicationId,
      width: 120,
      showRichFacade: true,
      canCopy: true,
    },
