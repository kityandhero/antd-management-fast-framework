...
import { FieldAllContentBusinessDrawer } from '../FieldAllContentBusinessDrawer';
import { FieldCustomContentBusinessDrawer } from '../FieldCustomContentBusinessDrawer';
import { FieldInheritedContentBusinessDrawer } from '../FieldInheritedContentBusinessDrawer';
import { SqlContentBusinessDrawer } from '../SqlContentBusinessDrawer';
...
class PageList extends MultiPage {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...this.state,
      pageTitle: '数据实体列表',
      paramsKey: accessWayCollection.sqlEntity.pageListBusiness.paramsKey,
      loadApiPath: 'sqlEntity/pageListBusiness',
      currentRecord: null,
    };
  }
  ...
  showFieldAllContentDrawer = (record) => {
    this.setState(
      ...
      () => {
        FieldAllContentBusinessDrawer.open();
      },
    );
  };
  ...
  showFieldCustomContentDrawer = (record) => {
    this.setState(
      ...
      () => {
        FieldCustomContentBusinessDrawer.open();
      },
    );
  };
  ...
  showFieldInheritedContentDrawer = (record) => {
    this.setState(
      ...
      () => {
        FieldInheritedContentBusinessDrawer.open();
      },
    );
  };
  ...
  renderPresetOther = () => {
    ...
    return (
      <>
        <SqlContentBusinessDrawer maskClosable externalData={currentRecord} />

        <FieldAllContentBusinessDrawer
          maskClosable
          externalData={currentRecord}
        />

        <FieldCustomContentBusinessDrawer
          maskClosable
          externalData={currentRecord}
        />

        <FieldInheritedContentBusinessDrawer
          maskClosable
          externalData={currentRecord}
        />
      </>
