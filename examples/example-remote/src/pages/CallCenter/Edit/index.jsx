...
class Edit extends DataTabContainerSupplement {
      ...
      buttons: [
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.callCenter.setOnline.permission,
          ),
        ...
        },
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.callCenter.setOffline.permission,
          ),
  ...
  establishPageHeaderContentGridConfig = () => {
    ...
    return [
      {
        label: fieldData.callCenterId.label,
        value: getValueByKey({
          data: metaData,
      ...
      {
        label: fieldData.contactInformation.label,
        value: getValueByKey({
          data: metaData,
