...
const visibleFlag = '796ae68f63ab46d9accdecf6ac7ab27d';
...
class ChangeSortModal extends BaseUpdateModal {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...this.state,
      pageTitle: '排序值设置',
      loadApiPath: 'callCenterCategory/get',
      submitApiPath: 'callCenterCategory/updateSort',
    };
  }
  ...
  supplementLoadRequestParams = (o) => {
    ...
    const { callCenterCategoryId } = externalData;

    d[fieldData.callCenterCategoryId.name] = callCenterCategoryId;
