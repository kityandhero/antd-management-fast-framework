...
const visibleFlag = 'cd195256fec04003bb46149442ae513f';
...
class ChangeSortModal extends BaseUpdateModal {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      submitApiPath: 'galleryCategory/updateSort',
    };
  }
  ...
  supplementLoadRequestParams = (o) => {
    ...
    const { galleryCategoryId } = externalData;

    d[fieldData.galleryCategoryId.name] = galleryCategoryId;
