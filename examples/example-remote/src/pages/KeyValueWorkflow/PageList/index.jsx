...
@connect(({ keyValueWorkflow, schedulingControl }) => ({
  keyValueWorkflow,
  schedulingControl,
}))
class PageList extends MultiPage {
  componentAuthority = accessWayCollection.keyValueWorkflow.pageList.permission;
  ...
  constructor(properties) {
    ...
    this.state = {
      ...this.state,
      pageTitle: '应用键值列表',
      paramsKey: accessWayCollection.keyValueWorkflow.pageList.paramsKey,
      loadApiPath: 'keyValueWorkflow/pageList',
  ...
  establishListItemDropdownConfig = (item) => {
    return {
      ...
      disabled: !checkHasAuthority(
        accessWayCollection.keyValueWorkflow.get.permission,
      ),
      ...
      items: [
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.keyValueWorkflow.refreshCache.permission,
          ),
          confirm: true,
          title: '即将刷新缓存，确定吗？',
        },
  ...
  getColumnWrapper = () => [
    ...
    {
      dataTarget: fieldData.keyValueWorkflowId,
      width: 120,
      showRichFacade: true,
      canCopy: true,
    },
