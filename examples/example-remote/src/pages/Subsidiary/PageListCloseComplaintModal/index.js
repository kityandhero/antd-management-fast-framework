...
const visibleFlag = '5ee8151b7995438eb8ce96ac08fb7eeb';

@connect(({ subsidiary, schedulingControl }) => ({
  subsidiary,
  schedulingControl,
}))
class PageListCloseComplaintModal extends MultiPageSelectModal {
  ...
  supplementLoadRequestParams = (o) => {
    ...
    d[fieldData.complaintSwitch.name] = whetherNumber.no;
...
export { PageListCloseComplaintModal };
