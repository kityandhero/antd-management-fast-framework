  ...
  return {
    ...
    effects: {
      ...
      *trySend(
        ...
        const response = yield call(trySendData, payload);
      ...
      *tryPeek(
        ...
        const response = yield call(tryPeekData, payload);
      ...
      *tryDequeue(
        ...
        const response = yield call(tryDequeueData, payload);
      ...
      *tryPurge(
        ...
        const response = yield call(tryPurgeData, payload);
