  ...
  return {
    ...
    effects: {
      ...
      *getNavigationItem(
        ...
        const response = yield call(getNavigationItemData, payload);
      ...
      *addNavigationItem(
        ...
        const response = yield call(addNavigationItemData, payload);
      ...
      *updateNavigationItem(
        ...
        const response = yield call(updateNavigationItemData, payload);
      ...
      *removeNavigationItem(
        ...
        const response = yield call(removeNavigationItemData, payload);
