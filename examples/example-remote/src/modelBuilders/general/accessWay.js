  ...
  return {
    ...
    effects: {
      ...
      *pageListAssemblyVerify(
        ...
        const response = yield call(pageListAssemblyVerifyData, payload);
      ...
      *getActionMap(
        ...
        const response = yield call(getActionMapData, payload);
      ...
      *getPermissionActionMap(
        ...
        const response = yield call(getPermissionActionMapData, payload);
      ...
      *getNonePermissionActionMap(
        ...
        const response = yield call(getNonePermissionActionMapData, payload);
      ...
      *testPermissionActionUnique(
        ...
        const response = yield call(testPermissionActionUniqueData, payload);
      ...
      *testPermissionAction(
        ...
        const response = yield call(testPermissionActionData, payload);
