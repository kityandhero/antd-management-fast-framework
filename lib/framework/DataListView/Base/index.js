...
var _EverySpace = _interopRequireDefault(
  require('../../../customComponents/EverySpace'),
);

var _IconInfo = _interopRequireDefault(
  require('../../../customComponents/IconInfo'),
);

var _EllipsisCustom = _interopRequireDefault(
  require('../../../customComponents/EllipsisCustom'),
);

var _Ellipsis = _interopRequireDefault(
  require('../../../customComponents/Ellipsis'),
);

var _ImageBox = _interopRequireDefault(
  require('../../../customComponents/ImageBox'),
);

var _HelpCard = _interopRequireDefault(
  require('../../../customComponents/HelpCard'),
);
...
var ListBase = /*#__PURE__*/ (function(_AuthorizationWrapper) {
  ...
  function ListBase(props) {
    ...
    _this.buildColumnItem = function(o) {
      ...
      var _showHelper$placehold = _objectSpread(
          _objectSpread(
            {},
            {
              showHelper: false,
      ...
      if ((dataTarget || null) == null) {
        var text = '\u9519\u8BEF\u7684\u5217\u914D\u7F6E,\u7F3A\u5C11dataTarget:'.concat(
          JSON.stringify({
        ...
        if ((label || null) == null || (name || null) == null) {
          var _text = '\u9519\u8BEF\u7684\u5217\u914D\u7F6E\uFF0CdataTarget\u5185\u5BB9\u7F3A\u5931:'.concat(
            JSON.stringify({
              column: o,
            }),
          );
      ...
      var _align$showRichFacade = _objectSpread(
          _objectSpread(
            {},
            {
              align: 'center',
      ...
      if (!(0, _tools.isFunction)(d.render) && showRichFacade) {
        var _canCopy$emptyValue$d = _objectSpread(
            _objectSpread(
              {},
              {
                canCopy: false,
        ...
        d.render = function(value, record) {
          ...
          if ((0, _tools.isFunction)(facadeConfigBuilder)) {
            facadeConfig = _objectSpread(
              _objectSpread({}, facadeConfig),
              facadeConfigBuilder(value, record) || {},
            );
          }

          if (
            (0, _tools.stringIsNullOrWhiteSpace)(facadeMode) ||
            facadeMode === _constants.columnFacadeMode.ellipsis
          ) {
            if ((0, _tools.isFunction)(d.formatValue)) {
              val = d.formatValue(value, record);
            }

            var _color$facadeConfig = _objectSpread(
                _objectSpread(
                  {},
                  {
                    color: null,
              ...
              return /*#__PURE__*/ _react['default'].createElement(
                ...
                /*#__PURE__*/ _react['default'].createElement(
                  _EllipsisCustom['default'],
                  {
                    ...
                    lines: 1,
                    removeChildren: true,
                    extraContent: /*#__PURE__*/ _react['default'].createElement(
                      _react['default'].Fragment,
                      null,
                      /*#__PURE__*/ _react['default'].createElement(
                        'a',
          ...
          if (facadeMode === _constants.columnFacadeMode.datetime) {
            var _color$datetimeFormat = _objectSpread(
                _objectSpread(
                  {},
                  {
                    color: null,
                    datetimeFormat:
                      _constants.datetimeFormat.yearMonthDayHourMinuteSecond,
                  },
                ),
                facadeConfig,
              ),
            ...
            val = (0, _tools.stringIsNullOrWhiteSpace)(val)
              ? ''
              : (0, _tools.formatDatetime)(val, datetimeFormatValue) || '';
            return /*#__PURE__*/ _react['default'].createElement(
              _react['default'].Fragment,
              null,
              /*#__PURE__*/ _react['default'].createElement(
          ...
          if (facadeMode === _constants.columnFacadeMode.money) {
            var _color$facadeConfig2 = _objectSpread(
                _objectSpread(
                  {},
                  {
                    color: null,
          ...
          if (facadeMode === _constants.columnFacadeMode.image) {
            ...
            var _imageWidth$circle$pr = _objectSpread(
                _objectSpread(
                  {},
                  {
                    imageWidth: '30px',
          ...
          if (facadeMode === _constants.columnFacadeMode.badge) {
            ...
            var _status$text$facadeCo = _objectSpread(
                _objectSpread(
                  {},
                  {
                    status: 'default',
    ...
    _this.buildSearchFormContentItem = function(contentItem, contentIndex) {
      ...
      var _lg$md$sm$xs$type$ico = _objectSpread(
          _objectSpread(
            {},
            {
              lg: 6,
      ...
      return /*#__PURE__*/ _react['default'].createElement(
        ...
        type === _constants.searchFormContentConfig.contentItemType.input
          ? _this.renderSearchInput(
              fieldData.label,
              fieldData.name,
          ...
          : null,
        type === _constants.searchFormContentConfig.contentItemType.inputNumber
          ? _this.renderSearchInputNumber(
              fieldData.label,
              fieldData.name,
              fieldData.helper,
              _objectSpread(
          ...
          : null,
        type === _constants.searchFormContentConfig.contentItemType.datePicker
          ? _this.renderFormDatePicker(
              fieldData.label,
              fieldData.name,
              false,
              fieldData.helper,
          ...
          : null,
        type ===
          _constants.searchFormContentConfig.contentItemType.customRangePicker
          ? _this.renderSimpleFormRangePickerCore(
              contentItem.dateRangeFieldName,
              _objectSpread(_objectSpread({}, {}), otherProps || {}),
            )
          : null,
        type ===
          _constants.searchFormContentConfig.contentItemType.onlyShowInput
          ? _this.renderFormOnlyShowInput(
              fieldData.label,
              contentItem.value,
              fieldData.helper || '',
              contentItem.icon ||
          ...
          : null,
        type === _constants.searchFormContentConfig.contentItemType.customSelect
          ? contentItem.component
          : null,
        type === _constants.searchFormContentConfig.contentItemType.customRadio
          ? contentItem.component
          : null,
        type ===
          _constants.searchFormContentConfig.contentItemType.innerComponent
          ? _this.renderFormInnerComponent(
              fieldData.label,
              component,
              fieldData.helper,
              null,
        ...
        list: [
          {
            lg: 10,
            type:
              _constants.searchFormContentConfig.contentItemType
                .customRangePicker,
      ...
      return /*#__PURE__*/ _react['default'].createElement(
        FormItem,
        {
          ...
          rules: [
            {
              required: false,
              message: (0, _tools.buildFieldDescription)(
                dateRangeFieldName,
                '选择',
              ),
            },
    ...
    _this.buildTableConfig = function() {
      ...
      return _objectSpread(
        _objectSpread({}, _this.buildTableOtherConfig()),
        {},
        {
          columns: columns,
          size: tableSize,
    ...
    _this.setColumnsMap = function(e) {
      if (Object.keys(e || {}).length === 0) {
        ...
        var columnsOtherConfigArrayChanged = (
      ...
      var counterSetColumnsOtherConfig =
        _this.state.counterSetColumnsOtherConfig;
    ...
    _this.renderBatchAction = function() {
      ...
      var selectRows = (0, _tools.isArray)(selectedDataTableDataRows)
        ? selectedDataTableDataRows
        : [];
    ...
    _this.getTabActiveKey = function() {
      ...
      return pathname
        .replace(/\//g, '-')
        .replace(''.concat(match.url.replace(/\//g, '-'), '-'), '')
        .replace(/-/g, '/');
    };
    ...
    _this.onPageHeaderAvatarLoadErrorCallback = function() {
      _this.setState({
        avatarImageLoadResult:
          _DecorateAvatar.avatarImageLoadResultCollection.fail,
      });
    };
    ...
    _this.pageHeaderAction = function() {
      ...
      return /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          (0, _FunctionComponent.buildButtonGroup)(buttonGroupData),
    ...
    _this.pageHeaderContentData = function() {
      return {
        list: [
          _this.pageHeaderContentGridConfig(),
          _this.pageHeaderContentParagraphConfig(),
          _this.pageHeaderContentActionConfig(),
        ],
      };
    };

    _this.renderPageHeaderContent = function() {
      return (0, _FunctionComponent.pageHeaderContent)(
        _this.pageHeaderContentData() || {},
      );
    };
    ...
    _this.renderPageHeaderExtraContent = function() {
      return (0, _FunctionComponent.pageHeaderExtraContent)(
        _this.pageHeaderExtraContentData(),
      );
    };
    ...
    _this.renderListViewItemActions = function(record, index) {
      var showListViewItemActionSelect =
        _this.state.showListViewItemActionSelect;
      ...
      if (actionSelect == null) {
        return _toConsumableArray(
          (0, _tools.isArray)(actionOthers) ? actionOthers : [],
        );
      }
    ...
    _this.buildToolBar = function() {
      ...
      var _stick$title$tools$co = _objectSpread(
          _objectSpread(
            {},
            {
              stick: false,
      ...
      var bar = /*#__PURE__*/ _react['default'].createElement(
        'div',
        {
          style: {
        ...
        /*#__PURE__*/ _react['default'].createElement(_card['default'], {
          ...
          extra: /*#__PURE__*/ _react['default'].createElement(
            Space,
            {
              split: /*#__PURE__*/ _react['default'].createElement(
                _divider['default'],
                {
                  type: 'vertical',
                },
    ...
    _this.buildHelp = function() {
      ...
      var _title$showNumber$lis = _objectSpread(
          _objectSpread(
            {},
            {
              title: '操作帮助',
      ...
      return /*#__PURE__*/ _react['default'].createElement(
        ...
        {
          border:
            mode !== _constants.contentConfig.wrapperType.model &&
        ...
        /*#__PURE__*/ _react['default'].createElement(
          _card['default'],
          {
            ...
            extra: /*#__PURE__*/ _react['default'].createElement(
              ...
              _this.renderBatchAction(),
              _this.renderCardExtraAction(),
            ),
          },
          /*#__PURE__*/ _react['default'].createElement(
            'div',
    ...
    _this.state = _objectSpread(
      _objectSpread(_objectSpread({}, _this.state), defaultState),
      {
        renderPageHeaderWrapper: true,
        listTitle: '检索结果',
        defaultAvatarIcon: /*#__PURE__*/ _react['default'].createElement(
          _icons.PictureOutlined,
          null,
        ),
        avatarImageLoadResult:
          _DecorateAvatar.avatarImageLoadResultCollection.wait,
    ...
    [
      {
        ...
        value: function render() {
          ...
          var avatarProps = showPageHeaderAvatar
            ? (0, _DecorateAvatar.decorateAvatar)(
          ...
          if (renderPageHeaderWrapper || false) {
            return /*#__PURE__*/ _react['default'].createElement(
              _proLayout.PageHeaderWrapper,
              {
                avatar: avatarProps,
                title: (0, _FunctionComponent.pageHeaderTitle)(
                  this.getPageName(),
                  this.pageHeaderTitlePrefix(),
                ),
                subTitle: this.pageHeaderSubTitle(),
                tags: (0, _FunctionComponent.pageHeaderTagWrapper)(
                  this.pageHeaderTag(),
                ),
