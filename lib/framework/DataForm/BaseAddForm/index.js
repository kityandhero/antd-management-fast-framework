...
var _DataCore2 = _interopRequireDefault(
  require('../../DataSingleView/DataCore'),
);
...
var BaseAddForm = /*#__PURE__*/ (function(_DataCore) {
  ...
  function BaseAddForm(props) {
    ...
    _this.buildInitialValues = function() {
      var initialValues = {};
      initialValues[_constants.formNameCollection.createTime.name] = (0,
      _tools.formatDatetime)(
        new Date(),
        _constants.datetimeFormat.yearMonthDayHourMinute,
      );
