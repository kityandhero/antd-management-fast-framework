...
var Base = /*#__PURE__*/function (_AuthorizationWrapper) {
  ...
  function Base() {
    ...
    _this.doAfterSubmitSuccess = function (singleData, listData, extraData, responseOriginalData, submitData) {
      var afterOK = _this.props.afterOK;

      _this.doOtherAfterSubmitSuccess(singleData, listData, extraData, responseOriginalData, submitData);

      _this.sendSubmitSuccessMessage(singleData, listData, extraData, responseOriginalData, submitData);

      _this.sendSubmitSuccessNotification(singleData, listData, extraData, responseOriginalData, submitData);
    ...
    _this.doOtherAfterSubmitSuccess = function ( // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    _this.sendSubmitSuccessMessage = function (singleData, listData, extraData, responseOriginalData, submitData) {
      var _type$text$_this$buil = _objectSpread(_objectSpread({}, {
        type: 'success',
        text: ''
      }), _this.buildMessage(singleData, listData, extraData, responseOriginalData, submitData)),
    ...
    _this.buildMessage = function ( // eslint-disable-next-line @typescript-eslint/no-unused-vars
    singleData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    listData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    extraData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    responseOriginalData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    submitData) {
      return {
        ...
        text: _this.buildMessageText(singleData, listData, extraData, responseOriginalData, submitData)
      };
    };
    ...
    _this.buildMessageText = function ( // eslint-disable-next-line @typescript-eslint/no-unused-vars
    singleData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    listData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    extraData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    responseOriginalData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    _this.sendSubmitSuccessNotification = function ( // eslint-disable-next-line @typescript-eslint/no-unused-vars
    singleData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    listData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    extraData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    responseOriginalData, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    submitData) {
      var _type$placement$messa = _objectSpread(_objectSpread({}, {
        type: 'success',
        ...
        description: _this.buildNotificationDescription(singleData, listData, extraData, responseOriginalData, submitData)
      }),
