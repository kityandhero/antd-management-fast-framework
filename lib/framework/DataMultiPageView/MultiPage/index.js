...
var MultiPage = /*#__PURE__*/function (_Base) {
  ...
  function MultiPage(props) {
    ...
    _this.handleFormReset = function () {
      var checkWorkDoing = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    ...
    _this.initLoadRequestParams = function (o) {
      ...
      if (_this.useParamsKey) {
        ...
        d = (0, _storageAssist.getUseParamsDataCache)(paramsKey);
        ...
        d = _objectSpread(_objectSpread({}, d), _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, formValues || {}), filters || {}), {
          pageNo: pageNo,
          pageSize: pageSize
        }), sorter || {}));
        delete d.dateRange;
    ...
    _this.afterGetFirstRequestResult = function (submitData, responseData) {
      ...
      if (pageKey === 'key' && p != null) {
        if (p.startTime && p.endTime) {
          p.dateRange = [(0, _tools.dateToMoment)(p.startTime), (0, _tools.dateToMoment)(p.endTime)]; // p.dateRange = `${p.startTime}-${p.endTime}`;
        }
    ...
    _this.afterGetRequestResult = function () {
      ...
      if (!(0, _tools.stringIsNullOrWhiteSpace)(paramsKey)) {
        (0, _storageAssist.setUseParamsDataCache)(paramsKey, _this.lastLoadParams);
      }
    };
    ...
    _this.renderTableView = function () {
      ...
      standardTableCustomOption.expandable = _objectSpread(_objectSpread({}, {}), expandable || {});
