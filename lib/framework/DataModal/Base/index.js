...
var _BaseWindow2 = _interopRequireDefault(
  require('../../DataOperation/BaseWindow'),
);
  ...
  function Base(props) {
    ...
    _this.buildOkButtonProps = function() {
      if (_this.reloadWhenShow) {
        var _buttonDisabled =
          _this.getSaveButtonDisabled() || _this.getOtherButtonDisabled();
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ _react['default'].createElement(
          _modal['default'],
          {
            ...
            visible: visible,
            maskClosable: (0, _tools.isUndefined)(maskClosable)
              ? false
              : maskClosable,
            zIndex: 1001,
