...
export async function getCurrentData() {
  ...
  return request(`${getApiVersion()}/currentOperator/getCurrent`);
}
...
export async function getCurrentBasicInfoData() {
  ...
  return request(`${getApiVersion()}/currentOperator/getCurrentBasicInfo`);
}
...
export async function updateCurrentBasicInfoData(params) {
  ...
  return request(`${getApiVersion()}/currentOperator/updateCurrentBasicInfo`, {
    method: 'POST',
    data: params,
  });
}
...
export async function changeCurrentPasswordData(params) {
  ...
  return request(`${getApiVersion()}/currentOperator/changeCurrentPassword`, {
    method: 'POST',
    data: params,
  });
}
