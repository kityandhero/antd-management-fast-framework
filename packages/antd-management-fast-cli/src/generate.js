  ...
  fs.pathExists("src", (err, exists) => {
    if (!exists) {
      ...
      switch (type) {
        case "page":
          ...
          fs.pathExists(pageFile, (err, exists) => {
            if (exists) {
              ...
              fs.copy(
                "/usr/local/lib/node_modules/vue-xu-generate/src/template/page.vue",
                pageFile,
                (err) => {
              ...
              fs.copy(
                "/usr/local/lib/node_modules/vue-xu-generate/src/template/page.less",
                styleFile,
                (err) => {
                  if (err) return console.error(err);
              ...
              fs.copy(
                "/usr/local/lib/node_modules/vue-xu-generate/src/template/page.js",
                jsFile,
                (err) => {
                  if (err) return console.error(err);
        ...
        case "component":
          ...
          fs.pathExists(componentFile, (err, exists) => {
            if (exists) {
              ...
              fs.copy(
                "/usr/local/lib/node_modules/vue-xu-generate/src/template/component.vue",
                componentFile,
                (err) => {
                  if (err) return console.error(err);
              ...
              fs.copy(
                "/usr/local/lib/node_modules/vue-xu-generate/src/template/component.less",
                cssFile,
                (err) => {
                  if (err) return console.error(err);
              ...
              fs.copy(
                "/usr/local/lib/node_modules/vue-xu-generate/src/template/component.js",
                jsxFile,
                (err) => {
                  if (err) return console.error(err);
                  console.log(componentFile + "  has created");
        ...
        default:
          term.red(
            `ERROR: uncaught type , you should input like $ xu g page demo`
          );
          console.log();
          console.log("  Examples:");
          console.log();
          term.gray("    # create a new page");
          console.log("    $ xu g page product");
          console.log();
          term.gray("    # create a new component");
          console.log("    $ xu g component  product");
          console.log();
          term.gray("    # create a new store");
