...
/**
 * Refined PureComponent, it is usually used in no remote api request simple scenarios
 */
class RefinedComponent extends PureComponent {
  mounted = false;
...
RefinedComponent.defaultProps = {
  ...defaultProps,
};

export { RefinedComponent };
