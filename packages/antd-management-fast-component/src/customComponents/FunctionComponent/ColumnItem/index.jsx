...
class AmfColumnItem extends BaseComponent {
  renderFurther() {
    logExecute('renderFurther', 'AmfColumnItem');

    const { columnConfig, attachedTargetName } = this.props;
...
AmfColumnItem.defaultProps = {
  columnConfig: {},
  attachedTargetName: '',
};

export { AmfColumnItem };
