...
export function buildModel() {
  return {
    namespace: 'sectionApplicationConfig',
    ...
    effects: {
      ...
      *getConfigItem(
        ...
        const response = yield call(getConfigItemData, payload);
      ...
      *addConfigItem(
        ...
        const response = yield call(addConfigItemData, payload);
      ...
      *updateConfigItem(
        ...
        const response = yield call(updateConfigItemData, payload);
      ...
      *removeConfigItem(
        ...
        const response = yield call(removeConfigItemData, payload);
