...
const visibleFlag = '6b2288dcc24c41b9bc8eb0479f99a6a4';
...
class ChangeBackwardModal extends BaseUpdateModal {
  static open() {
          ...
          items: [
            {
              ...
              fieldData: fieldData.backwardId,
              listData: list,
            },
          ],
        },
