...
export function renderSearchFlowCaseProcessHistoryStatusSelect({
  ...
  return buildSearchFormSelect({
    ...
    name,
    helper,
    list: refitFlowCaseProcessHistoryStatusList({ withUnlimited }),
...
export function renderCustomFlowCaseProcessHistoryStatusSelect({
  ...
  return buildFlexSelect({
    ...
    separator,
    size,
    list: refitFlowCaseProcessHistoryStatusList({ withUnlimited: true }),
    dataConvert: convertOptionOrRadioData,
    renderItem: null,
    onChange: onChangeCallback,
...
export function renderFlowCaseProcessHistoryStatusDropDown({
  ...
  return buildDropdownMenu({
    ...
    icon,
    size,
    list: refitFlowCaseProcessHistoryStatusList({ withUnlimited: false }),
    dataConvert: null,
    onClick: onClickCallback,
    innerProps: innerProperties || null,
  });
